...
Food AM = Food(
    coverImage: 'assets/materials/egg.png',
    title: 'እንቁላል',
    ...
    facts: Column(children: [
      Row(
        ...
        children: const [
          CategoryButton(
              horizontal: true,
              text: 'ቫይታሚን ኤ 6% የ RDA (የሚመከር ዕለታዊ አበል)',
      ...
      Row(
        ...
        children: const [
          CategoryButton(
              horizontal: true,
              text: 'ቫይታሚን B5 7% የ RDA',
              icon: 'assets/icons/vitamin_b5.png'),
          CategoryButton(
              horizontal: true,
              text: 'ቫይታሚን B12 9% የ RDA',
    ...
    body: Column(
      ...
      children: const [
        ...
        CourseBodyImage(image: 'assets/materials/egg_boiled.png'),
        Paragraph(
        ...
        CourseBodyImage(image: 'assets/materials/egg_scrumbled.png'),
        Paragraph(
        ...
        Bullet(children: [
          ...
          'ከዕለታዊ የ folate ፍላጎቶችዎ 50%',
          'ከዕለታዊ የሪቦፍላቪን (ቫይታሚን B2) ፍላጎቶች 25%',

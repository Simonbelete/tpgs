...
Course SW = Course(
  ...
  body: Column(crossAxisAlignment: CrossAxisAlignment.start, children: const [
    ...
    Bullet(children: [
      ...
      'Hakikisha kuwa mahali pako ni safi bila takataka na hakuna wadudu kama vile panya, mijusi wa nyumbani na mende.',
    ...
    Paragraph(
        title: '',
        body:
            'Shughuli nyingi za ndani na nje ya nyumba zetu hutuweka wazi kwa uchafu na vijidudu kutoka sehemu mbalimbali. Tunahitaji kuwa makini jikoni na kujiepusha na takataka, moshi na wadudu kama panya. Jizoeze kila mara tabia hizi safi na zenye afya unapotayarisha chakula jikoni.'),
    Paragraph(

...
Course SW = Course(
  ...
  body: Column(crossAxisAlignment: CrossAxisAlignment.start, children: const [
    ...
    SubTitleText(text: "1. Helps build muscles."),
    Paragraph(
        title: "",
        body:
    ...
    SubTitleText(text: "2. Keeps your bones healthy."),
    Paragraph(
        title: "",
        body:
    ...
    SubTitleText(text: "3. Relieves stress."),
    Paragraph(
        title: "",
        body:
    ...
    SubTitleText(text: "4. Reduces pre-menstrual syndrome symptoms."),
    Paragraph(
        title: "",
        body:
    ...
    SubTitleText(text: "7. Promotes heart health."),
    Paragraph(
        title: "",
        body:

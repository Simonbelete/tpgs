...
Course AM = Course(
  ...
  body: Column(crossAxisAlignment: CrossAxisAlignment.start, children: const [
    ...
    SubTitleText(text: "1. የዶሮ ስጋ ጡንቻዎችን ለመገንባት ይረዳል"),
    Paragraph(
        title: "",
        body:
    ...
    SubTitleText(text: "2. የዶሮ ስጋ አጥንትዎን ጤንነት ይጠብቃል"),
    Paragraph(
        title: "",
        body:
    ...
    SubTitleText(text: "3. የዶሮ ስጋ ጭንቀትን ያስወግዳል"),
    Paragraph(
        title: "",
        body:
    ...
    SubTitleText(text: "4. የዶሮ ስጋ ከወር አበባ በፊት ያለ ህመምን ይቀንሳል"),
    Paragraph(
        title: "",
        body:
    ...
    SubTitleText(text: "5. የዶሮ ስጋ የቴስቶስትሮን መጠን እንዲጨምር ይረዳል።"),
    Paragraph(
        title: "",
        body:
            "ወንዶች በዚንክ የበለፀጉ ምግቦችን መመገብ አለባቸው ምክንያቱም ቴስቶስትሮን መጠንን ለመቆጣጠር እና የወንድ የዘር ፍሬን ለማምረት ይረዳል ።"),
    SubTitleText(text: "6. የዶሮ ስጋ በሽታ የመከላከል አቅምን ይጨምራል።"),
    Paragraph(
        title: "",
        body:
    ...
    SubTitleText(text: "7. የዶሮ ስጋ የልብ ጤናን ያበረታታል።"),
    Paragraph(
        title: "",
        body:
    ...
    SubTitleText(text: "ሀ. አርስቶ አጠባበስ"),
    ...
    SubTitleText(text: "የስጋ መጥበስ ጥቅሞች"),
    Bullet(children: [
    ...
    SubTitleText(text: "የጊዜ እና የሙቀት መጠን ቁጥጥር"),
    Bullet(children: [
    ...
    // ]),
    SubTitleText(text: "ለ መጥበስ"),
    Paragraph(
        title: "",
        body:
            "መጥበስ ከፍተኛ ሙቀትን የሚያካትት ፈጣን፣ ምቹ እና ታዋቂ የማብሰል ዘዴ ነው። ቅባቶች ወይም ዘይቶች ጥቅም ላይ ይውላሉ፡፡"),
    Paragraph(
        title: "ሁለት ዓይነት የመጥብስ ዘዴዎች አሉ፡፡:-",
        body: "ለብ ለብ አጠባበስ and በጥልቀት መጥበስ"),
    SubTitleText(text: "ለ.ሀ ለብ ለብ አጠባበስ"),
    SubTitleText(

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('week', models.IntegerField(default=0)),
                ('weight', models.FloatField()),
                ('chicken', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='weights', to='chickens.chicken')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
                ('flock', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='weights', to='flocks.flock')),
                ('weight_unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='weights', to='units.unit')),
            ],
            options={

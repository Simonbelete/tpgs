...
class FormulaSerializer_GET(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'name', 'display_name', 'purpose', 'weight', 'note', 'budget', 'desired_ratio', 'desired_dm',
                  'ration_price', 'ration_ratio', 'ration_weight', 'ration_dm', 'requirement', 'unit_price', 'sex', 'formula_basis', 'purpose',
...
class FormulaSerializer_POST(serializers.ModelSerializer):
    ...
    class Meta:
        model = models.Formula
        fields = ['id', 'name', 'weight', 'requirements', 'budget', 'desired_ratio', 'desired_dm', 'ingredients', 'requirement', 'is_active', 'sex', 'formula_basis', 'purpose',

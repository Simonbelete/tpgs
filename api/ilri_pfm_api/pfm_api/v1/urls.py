...
from pfm_api.v1.views import UserViewSet, DeviceViewSet, UserUidViewSet, FarmViewSet, ChickenViewSet, ChickenParentViewSet, BreedTypeParentViewSet, ChickenStageParentViewSet, EggParentViewSet, LayedPlaceViewSet

...
import { Grid, Stack, Tabs, Tab, Box, tabsClasses, InputAdornment, Button } from "@mui/material";
...
const IngredientForm = ({
  ...
  const onSubmit: SubmitHandler<Inputs> = async (data) => {
    if (ingredient == null) await createIngredient({...data, nutrients: selector.nutrients});

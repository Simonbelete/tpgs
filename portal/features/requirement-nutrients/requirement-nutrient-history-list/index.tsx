...
import { RequirementNutrient, RequirementNutrientHistory } from "@/models";
import { IconButton, Tooltip, Typography, Button } from "@mui/material";
import Link from "next/link";

export const RequirementNutrientHistoryList = ({
  data,
}: {
  ...
  return (
    <HistoryList<RequirementNutrientHistory>
      columns={columns}
      getHistoryQuery={{ id: data.id, query: {} }}
      getHistoryEndpoint={
        requirementNutrientApi.endpoints.getRequirementNutrientHistory
      }
    />
  );
};

...
const UnitFilter = () => {
  ...
  const handleActiveChange = (event: SelectChangeEvent) => dispatch(unitListSlice.actions.setIsActive((event.target.value as any).value))
      ...
      <Grid container alignItems={"center"}>
        ...
        <Grid item xs={12} md={4}>
          <Stack
            ...
            spacing={2}
          >
            <SearchInput label="Search..."  onChange={(event: React.ChangeEvent<HTMLInputElement>) => dispatch(unitListSlice.actions.setSearch(event.target.value)) }/>

...
import { chickenListSlice } from "./slice";
...
const ChickenFilter = () => {
  ...
  const handleSearchButton = () => dispatch(chickenListSlice.actions.reset());
      ...
      <Grid container alignItems={"center"}>
        ...
        <Grid item xs={12} md={4}>
          <Stack
            ...
            spacing={2}
          >
            <SearchInput label="Search..."  onChange={(event: React.ChangeEvent<HTMLInputElement>) => dispatch(chickenListSlice.actions.setSearch(event.target.value)) }/>
          ...
          >
            ...
            <Box>
              <Button
                ...
                size="small"
                disableElevation
                onClick={() => dispatch(chickenListSlice.actions.reset())}
              >
                Clear
              </Button>
            </Box>

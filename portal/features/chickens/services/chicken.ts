...
export const chickenApi = baseApi.injectEndpoints({
  endpoints: (build) => {
    return {
      ...
      getChickenOffspring: build.query<Response<Chicken[]>, {id: number, query: Object}>({ query: ({id, query}) => ({ url: `${URL}/${id}/offspring/`, method: 'get', params: query })}),
      getChickenAncestors: build.query<Response<Chicken[]>, {id: number, query: Object}>({ query: ({id, query}) => ({ url: `${URL}/${id}/ancestors/`, method: 'get', params: query })}),
      getChickenSiblings: build.query<Response<Chicken[]>, {id: number, query: Object}>({ query: ({id, query}) => ({ url: `${URL}/${id}/siblings/`, method: 'get', params: query })}),

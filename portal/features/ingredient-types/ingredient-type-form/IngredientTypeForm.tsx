...
import { useCreateIngredientTypeMutation, useUpdateIngredientTypeMutation } from "../services";
...
const IngredientTypeForm = ({
  ...
  const [createIngredientType, createResult ] = useCreateIngredientTypeMutation();
  ...
  const onSubmit: SubmitHandler<Inputs> = async (data) => {
    if (ingredient_type == null) await createIngredientType(data);
      ...
      <Grid item xs={3}>
        <Stack spacing={3}>
          {ingredient_type && (
            ...
            <IngredientTypeDangerZone id={ingredient_type.id} is_active={ingredient_type.is_active} />
            </>
          )}
        </Stack>
      </Grid>

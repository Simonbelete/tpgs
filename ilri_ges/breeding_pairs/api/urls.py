...
from .views import BreedPairViewSet, BreedPairTreeViewSet, BreedPairHistoryViewSet, BreedPairChildrenViewSet
...
router.register(r'breeding-pairs/(?P<id>.+)/children',
                BreedPairChildrenViewSet, basename='api_breeding_pairs_children'),
